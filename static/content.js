...
function handleResponse(message) {
	...
	var responseValue = Object.values(recievedData)[0];
	...
	if (responseValue == null || undefined) {
		...
		const actualUsage = document.querySelectorAll('input')[37].value;
		// @ts-ignore
		...
		let notLight = document.getElementsByClassName('notification-light');
	...
	if (responseValue == null || '') {
		...
		let notLight = document.getElementsByClassName('notification-light');
		notLight[0].removeAttribute('style');
	}
}
...
function notifyBackgroundPage() {
	if (document.querySelectorAll('input')[18] == null) {
		console.log('Empty Field');
	}
	if (document.querySelectorAll('input')[18].value !== null) {
